...
export default function Home1Page() {
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="min-h-screen bg-gradient-to-b from-blue-400 via-blue-300 to-gray-100 rounded-lg overflow-hidden">
        {/* Header */}
        ...
        <section className="max-w-6xl mx-auto px-6 py-12">
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Optimize Family, Dating, Life Rhythms, Improve Nutritional Habits, Enhance Physical Fitness, And
                Cultivate Meaningful Relationships For A Fulfilling Life.
              </p>
            </div>
          </div>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-4 max-w-3xl mx-auto">
              This tool helps you identify, express, and/or resolve a difference in opinion on how you feel, think,
              think, and guess about various aspects of your relationship.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-8 mb-16 shadow-sm">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                AlignSynch asks you both to Focus on the "Same Topic" and rate how you feel about specific aspects of
                your <span className="bg-blue-100 px-1">Relationship</span>.
              </p>
              <p>
            ...
            <div className="max-w-4xl mx-auto space-y-4">
              {[
                ...
                },
                {
                  ...
                  answer:
                    "Improved communication and understanding leads to better emotional health for both partners.",
                },
                {
                  question: "Longevity",
                  answer:
          ...
          <div className="text-center mb-16">
            <div className="bg-gray-800 text-white p-8 rounded-lg max-w-2xl mx-auto">
              <p className="mb-6">
                Ready to transform your relationships? Start your journey with AlignSynch today and discover the power
                of true alignment and synchronization in all your relationships.
              </p>
