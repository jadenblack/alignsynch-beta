...
import { User, BarChart3, Calendar, ArrowUpRight, Heart, Trophy } from "lucide-react"
          ...
          <div className="bg-card rounded-xl p-6 shadow-sm mb-8 flex flex-col md:flex-row gap-6 items-center md:items-start">
            ...
            <div className="flex gap-2">
              ...
              <Link href="/session/new">
                <Button className="highlight-button">Start New Session</Button>
              </Link>
            </div>
          </div>
                    ...
                    {userData.categoryPerformance.map((category) => (
                      <div key={category.category}>
                        ...
                        <div className="w-full bg-muted rounded-full h-2.5">
                          <div className="bg-primary h-2.5 rounded-full" style={{ width: `${category.score}%` }}></div>
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          {activeTab === "history" && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>All sessions you've completed</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[...userData.recentSessions, ...userData.recentSessions].map((session, index) => (
                    <div
          ...
          {activeTab === "achievements" && (
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    {["Financial Harmony", "Communication Pro", "Goal Setter", "10 Sessions"].map((badge) => (
